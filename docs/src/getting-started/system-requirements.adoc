...
check the https://www.debian.org/releases/devel/amd64/ch02.en.html[Debian]
...
The distributed package for this reduced tree is "linuxcnc-uspace".

The realtime kernel option is preempt-rt.
